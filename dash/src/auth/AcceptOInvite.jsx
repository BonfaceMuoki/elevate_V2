...
import { useGetOInviteDetailsQuery } from "../api/auth/authApiSlice";
import { Alert } from "reactstrap";
import { toast } from "react-toastify";


import { selectOInviteToken, setOInviteToken } from "../featuers/authSlice";
...
const AcceptOInvite = () => {
    ...
    const {
        ...
        isError,
        error,
    } = useGetOInviteDetailsQuery(params.get("oinvite_token"));
    console.log("retrieved");
    console.log(retrieved);
    useEffect(() => {
        // alert(retrieved?.invite_token)
        dispatch(setOInviteToken(retrieved?.invite_token));


    }, [retrieved])
    console.log(useSelector(selectOInviteToken), useSelector(selectOInviteToken));
    //register form
    ...
    const sendRequestForm = async (data) => {
        ...
        formDatareg.append("invite_type", "nonspecificlink");
            ...
            return (
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh" }}>
                    <Alert className="alert-icon" color="danger">
                        ...
                        {
                            (!loadingInviteDetails) && <strong>Invalid/Expired Credetials</strong>
                        }
