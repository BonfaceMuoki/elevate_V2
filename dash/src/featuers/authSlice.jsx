...
export const { setActiveProductGlobal, clearCart, reduceCartItemQTY, removeCartItem, setCartItems, setOInviteToken, setMainRole, setSystemWallet, setUserWallet, setActiveMemberProfile, setInviteToken, setActiveGlobalTier, setActiveUserDetails, setActiveSupplierDetails, setHasInvested, setReportSignatories, setReportRecipient, updateUserDetails, setCredentials, logOut, setMode, setfetchvaluationreports, setValuationLocationDetails, setValuationPropertyDetails, setValuationDetails } = authSlice.actions
