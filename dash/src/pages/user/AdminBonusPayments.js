...
import { useGetUsersQuery, useDeactivateUserMutation, useGetTierEarningsQuery, usePayMemberBonusMutation, useGetBonusPaymentsQuery } from "../../api/admin/adminActionsApi";
...
function AdminBonusPayments() {
    ...
    const { data: bonusPayments, isLoading: loadingBonusPayment, refetch: refetchBonusPayments0 } = useGetBonusPaymentsQuery();
    ...
    const sendPayment = async (earning, action) => {
        ...
        alert(earning?.recipient[0]?.wallet_id);
                                                ...
                                                <DataTableRow>
                                                    ...
                                                    <div className="user-card">
                                                        <UserAvatar
                                                            theme="default"
                                                            text={findUpper(
                                                                bonusPayment.recipient[0].full_name != null && bonusPayment.recipient[0].full_name != undefined ? bonusPayment.recipient[0].full_name : ""
                                                            )}
                                                            image=""
                                                        ></UserAvatar>
                                                        <div className="user-info">
                                                            <span className="tb-lead">
                                                                ...
                                                                <span
                                                                    className={`dot dot-${bonusPayment.recipient[0].status === "Active"
                                                                        ? "success"
                                                            ...
                                                            <span>{bonusPayment.recipient[0].email}</span><br></br>
                                                            {/* <span></span><br></br> */}
                                                            <span>{bonusPayment.recipient[0]?.payment_method} - {bonusPayment.recipient[0]?.wallet_id}</span><br></br>
                                                            {/* user_account */}
                                                        </div>
                                                    </div>
                                                </DataTableRow>
