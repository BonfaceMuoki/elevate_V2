...
import { reduceCartItemQTY, removeCartItem, selectActiveSupplierDetails, selectCartItems, setActiveProductGlobal, setCartItems } from "../../featuers/authSlice";
...
function ProductsList() {
    ...
    const { data: allcategories,
        ...
        refetch: refetchCategories } = useGetAllCategoriesQuery();
    const setCat = (cat) => {
                                        ...
                                        <BlockHead size="" wide="">
                                            <Row className={`justify-between g-2 with-export}`}>
                                                <Col sm="12" md="6">
                                                    ...
                                                    <label>Search By Product Name</label><br></br>
                                                    <input
                                                        type="search"
                                                ...
                                                <Col sm="12" md="3">
                                                    <div id="DataTables_Table_0_filter" className="dataTables_filter">
                                                        <label>Search By Category</label><br></br>
                                                        <select
                                                            style={{ width: "100%" }}
                                            ...
                                            <Row className="g-gs">
                                                {
                                                    (supplierproducts != undefined && supplierproducts.data != null) ?
                                                        supplierproducts.data.map((item) => {
                                                            ...
                                                            return (<Col xxl={3} lg={4} sm={6} key={item.id}>
                                                                <Card className="card-bordered product-card">
                                                                    <div className="product-thumb">
                                                                        <a onClick={() => showProductImages(item)}>
                                                                            <img className="card-img-top" style={{ maxHeight: "300px", minHeight: "300px" }} src={`${process.env.REACT_APP_API_IMAGE_BASE_URL}/${item?.default_image?.image_url}`} alt="" />
                                                                        </a>
                                                                    ...
                                                                    <div className="card-inner text-center">
                                                                        ...
                                                                        <h5 className="product-title">
                                                                            <a style={{ cursor: "pointer" }} onClick={() => goToProductDetails(item)} >{item.product_name}</a>
                                                                        </h5>
                                                                        <div className="product-price text-primary h5">
                                                                            {item.price && <small className="text-muted del fs-13px">{item?.currency?.currency_abreviation} {item?.price + 300}</small>} {item?.currency?.currency_abreviation}
                                                                    ...
                                                                    <div className="card-inner text-center">
                                                                        {
                                                                            (indexIfFound > -1) ?
                                                                                ...
                                                                                : <Button color="primary" onClick={() => addItemToCart(item)}>Add to Cart</Button>
                                                                        }
