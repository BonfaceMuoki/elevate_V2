...
function AdminuserSuppliersList() {
                            ...
                            <tbody>
                              {
                                user.matrix_payments.map((matrixp, matkey) => {
                                  return (
                                    <tr key={matkey}>
                                      <td>{matrixp.amount_paid}</td>
                                      <td>

                                        {matrixp.status != "" && <Badge color="info">Not Progressed but Receiving</Badge>}
                                  ...
                                  <ul className="link-list-opt no-bdr">
                                    {user?.status === 1 && (
                                      <React.Fragment>
                                        ...
                                        <li className="divider"></li>
                                        <li onClick={() => viewUserProfile(item)}>
                                          <DropdownItem
                                            tag="a"
                                            href="#suspend"
                                            onClick={(ev) => {
...
export default AdminuserSuppliersList;
