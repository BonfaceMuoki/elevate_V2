    ...
    <table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#f2f3f8"
        ...
        <tr>
                <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                    ...
                    <tr style="">
                        <td style="text-align:center; background-color:#6576ff;height: 50px;color:white; " >                      
                        {{config('app.name')}}
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <p
                                            ...
                                            Hello {{$invite->invite_name}}, </p>
                                       <p style="text-align:left;">
                                        {{$inviting_user->full_name}} ,invited you to elavate an investment platform. </p>
                                        <p style="text-align:left;">To join your community simply click the button below to create an account.
                                        </p>
                                        <a href="{{$rgistrationcallbackurl}}?token={{$token}}"
                                            style="background:#6576ff;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">
